...
func (tx *Tx) Bucket(name []byte,number bool) *Bucket {
	return tx.root.Bucket(name,number)
}

// CreateBucket creates a new bucket.
// Returns an error if the bucket already exists, if the bucket name is blank, or if the bucket name is too long.
// The bucket instance is only valid for the lifetime of the transaction.
func (tx *Tx) CreateBucket(name []byte, number bool) (*Bucket, error) {
	return tx.root.CreateBucket(name, number)
}

// CreateBucketIfNotExists creates a new bucket if it doesn't already exist.
// Returns an error if the bucket name is blank, or if the bucket name is too long.
// The bucket instance is only valid for the lifetime of the transaction.
func (tx *Tx) CreateBucketIfNotExists(name []byte, number bool) (*Bucket, error) {
	return tx.root.CreateBucketIfNotExists(name, number)
}
...
func (tx *Tx) checkBucket(b *Bucket, reachable map[pgid]*page, freed map[pgid]bool, ch chan error) {
	...
	_ = b.ForEach(func(k, v []byte) error {
		if child := b.Bucket(k,b.Number); child != nil {
